...
import { Container, Items } from "../components/signUp/SignUpComponent";
...
const SignUp = () => {
  ...
  return (
    <Container>
      ...
      <Items variant="item2">
        {isEmail && isPw && isConPw && isName && isTelNum ? (
          <ButtonComponent enabeld onClick={onClickSignUp}>
            회원 가입
          </ButtonComponent>
        ) : (
